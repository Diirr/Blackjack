...
public class GameMaster{
  ...
  public String printWait(int s, int str, int x, int y) throws Exception {

    String strDefault = "Fehler 404";
    String str1 = "Der Dealer hat eine "+x+" erhalten. Der aktuelle Kartenwert des Dealers beträgt "+y+".";
    String str2 = "Sie haben eine "+x+" erhalten. Ihr aktueller Kartenwert beträgt "+y+".\n";
    ...
    String str11 = "Sie haben ein Ass erhalten. Soll es als 1 oder 11 gewertet werden?\n\n 1. Ass als 1 werten! \n2. Ass als 11 werten!\n";
  ...
  public boolean playAGame() throws Exception{
    ...
    System.out.println(printWait(2,1,tmpDealer, dealerFirst));
    System.out.println(printWait(2,2, tmpPlayer, player));
...
//Ab Runde 3 spielt der Spieler
    ...
    while(auswahl!=2&&player<21){
      ...
      if(auswahl == 1 && karte != 11){
        player += karte;
        System.out.println(printWait(2,2,karte,player));
        }

      //Der Spieler zieht eine Karte und hat ein Ass gezogen
      if(auswahl == 1 && karte == 11){
        System.out.println(printWait(1,11,0,0));
...
/*---------------------------------------------------------------------------------------------------------------*/
    ...
    while(dealerSecond<17){
      ...
      System.out.println(printWait(1,1,tmpDealer,dealerSecond));
    }
